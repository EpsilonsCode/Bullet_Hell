...
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=2}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[0f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=2}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[90f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=2}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[180f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=2}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[270f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=3}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[45f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=3}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[135f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=3}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[225f,-10f]}
execute as @e[type=husk,scores={BulletTimer=10..,Pattern=3}] at @s anchored eyes run summon bullethell:orb ^ ^-1 ^ {Tags:["motion_projectile"],Rotation:[315f,-10f]}
scoreboard players add @e[type=husk,scores={BulletTimer=20..,Pattern=0..1}] Pattern 1
scoreboard players set @e[type=husk,scores={BulletTimer=20..,Pattern=0..}] BulletTimer 0
