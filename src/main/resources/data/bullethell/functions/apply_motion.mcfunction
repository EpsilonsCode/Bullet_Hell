...
execute store result entity @s Motion[0] double 0.003 run scoreboard players operation @s motion_x2 -= @s motion_x1
execute store result entity @s Motion[1] double 0.003 run scoreboard players operation @s motion_y2 -= @s motion_y1
