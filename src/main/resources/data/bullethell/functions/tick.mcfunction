execute as @e[tag=motion_projectile_deviate,tag=!motion_added] at @s facing entity @p eyes run function bullethell:deviate
execute as @e[tag=motion_projectile_deviate,tag=!motion_added] at @s facing entity @p eyes run function bullethell:apply_motion
