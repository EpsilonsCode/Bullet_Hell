...
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[22.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[67.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[112.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[157.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[202.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[247.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[292.5f,0f]}
execute as @e[type=creeper,scores={BulletTimer=60..}] at @s anchored eyes run summon bullethell:orb ^ ^ ^ {Tags:["motion_projectile"],Rotation:[337.5f,0f]}
